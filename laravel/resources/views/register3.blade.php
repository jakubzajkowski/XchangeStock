...
<main class="w-100 text-dark">
    <section class="w-100 mx-auto bg-primary">
        <div class="mx-auto position-relative d-flex justify-content-between m-5 step--baner">
            ...
            <h3 class="step--baner--step step--3 step--1-first_page" >3</h3>
      ...
      <div class="container w-75 p-2 mx-2 text-dark mx-auto">
        <div class="row p-2">
            <div class="col-sm p-4">
              <h2>Your Experience <span class="mx-5 apply--info" style="font-size: 0.7rem">Apply within 5 minutes</span></h2>
              <form class="form-horizontal w-100" action="http://127.0.0.1:8000/register3" method="POST">
                @csrf
                <div class="form-group">
                  <label class="control-label col-sm-4" for="job">How many years you are in currency:</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control m-2" id="job" placeholder="Enter Years" name="years">
                    <span class="text-danger" style="font-size: 0.7rem">@error('years'){{$message}}*@enderror</span>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" for="agr">How old are you:</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control m-2" id="age" placeholder="Enter Your Age" name="age">
                    <span class="text-danger" style="font-size: 0.7rem">@error('age'){{$message}}*@enderror</span>
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" for="pwd">Your interest currency:</label>
                  <div class="col-sm-10">          
                    <select name="currency" id="currency" class="mx-2 p-1">
                        <option value="crypto">crypto</option>
                        <option value="normal">normal</option>
                        <option value="gold">gold</option>
                    </select>
                    <span class="text-danger" style="font-size: 0.7rem">@error('currency'){{$message}}*@enderror</span>
                  </div>
                </div>
                </div>
                <div class="form-group">        
